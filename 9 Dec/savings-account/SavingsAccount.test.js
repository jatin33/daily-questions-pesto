...
describe('SavingsAccount', () => {
  ...
  test('should throw error if firstname not between 3 and 20 characters long', () => {
    expect(() => new SavingsAccount('123456', 'kohli@gmail.com', 'V', 'Kohli')).toThrow('First name must be between 3 and 20 characters long');
  });

  test('should throw error if lastname has anything else except english alphabets', () => {
